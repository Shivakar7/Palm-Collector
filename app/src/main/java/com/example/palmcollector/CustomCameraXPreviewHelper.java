...
public class CustomCameraXPreviewHelper extends CameraHelper {
    ...
    private final CustomCameraXPreviewHelper.SingleThreadHandlerExecutor renderExecutor = new CustomCameraXPreviewHelper.SingleThreadHandlerExecutor("RenderThread", 0);
    ...
    public CustomCameraXPreviewHelper() {
    }
...
//                FocusMeteringAction.Builder builder = new FocusMeteringAction.Builder(point);
//                FocusMeteringAction action = builder.addPoint(point).build();
